...
sphere(texture="https://m.media-amazon.com/images/I/71dPYOSYfKL._SS500_.jpg",radius=300)





sol = sphere(pos=vec(0,0,0), radius=1, color=color.yellow,text='sol')

#t1 = text(text='sol', align='center', height=0.5,color=color.yellow, billboard=True, emissive=True)
...
################################################################
# definimos la funcion plan jupiter
...
prtcl1 = sphere(pos=vector(xp1,yp,zp), radius=0.5, color=color.red, make_trail=True,texture="https://m.media-amazon.com/images/I/71dPYOSYfKL._SS500_.jpg")
#t11 = text(text='jupiter', pos=prtcl1.pos+prtcl1.axis, height=1,color=color.yellow, billboard=True, emissive=True)# 

prtcl2 = sphere(pos=vector(xp2,yp,zp), radius=0.9, color=color.yellow, make_trail=True,texture="https://www.meteorologiaenred.com/wp-content/uploads/2018/07/Planeta-J%C3%BApiter.png",tex='saturno' )
